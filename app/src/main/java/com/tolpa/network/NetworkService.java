...
public class NetworkService extends IntentService {
    ...
    public static final String ACTION_CREATE_EVENT = "com.tolpa.network.action.FOO";
    private static final String ACTION_LOAD_EVENTS = "com.tolpa.network.action.LOAD" ;
    private static final String ACTION_BAZ = "com.tolpa.network.action.BAZ";

    // TODO: Rename parameters
    private static final String DATA = "com.tolpa.network.extra.PARAM1";
    private static final String IMAGE = "com.tolpa.network.extra.PARAM2";
    public static final String STATUS = "status";
    public static final String ID = "id";
    private static final String CATEGORY = "category";
    public static final String ACTION_UPDATE_EVENT = "com.tolpa.network.action.UPDATE" ;
